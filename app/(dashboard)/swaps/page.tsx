  ...
  return (
    <Box sx={{ p: 3 }}>
      <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 3 }}>
        ...
        >
          <SwapHorizIcon sx={{ fontSize: 32, color: 'white' }} />
        </Box>
        <Box>
      ...
      <Paper sx={{ p: 4, border: '1px solid #e2e8f0', borderRadius: 2 }}>
        <Typography variant="body1" sx={{ color: '#475569', mb: 2 }}>
          Approve or deny swap requests, view swap history, and configure swap policies for your
          team.
        </Typography>
        {loading ? (
          <Stack spacing={1}>
              ...
              return (
                ...
                >
                  <Typography sx={{ flex: 1, minWidth: 200 }}>
                    {displayName} — {date} {window} • {i.type}
                  </Typography>
